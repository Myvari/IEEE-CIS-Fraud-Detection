...
*(ფაილების ზომის გამო ვერ მოხდა data/* ფოლდერის ატვირთვა რეპოზიტორიაში, კოდის ლოკალურად გაშვებისთვის საჭიროა შესაბამისი [ფაილების](https://www.kaggle.com/competitions/ieee-fraud-detection/data?select=train_transaction.csv) გადმოწერა და ქვემოთ მოცემული ფაილური სტრუქტურის ქონა)*
